...
async function scrapeToolify() {
  ...
  try {
    ...
    // Step 1: Collect all tool slugs and logos from /most-saved page
    console.log('📋 Step 1: Collecting tool slugs and logos from /most-saved page...');
    const url = 'https://www.toolify.ai/most-saved';
